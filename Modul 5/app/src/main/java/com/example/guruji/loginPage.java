        ...
        buttonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (email.equals("bonaventura@gmail.com") && password.equals("215150401111051")) {
                    // Login is successful, create an Intent to start MrHeadActivity
                    Intent intent = new Intent(loginPage.this, MrHeadActivity.class);

                    // Put the email and password as extras in the Intent
                    intent.putExtra("email", email);
                    intent.putExtra("password", password);

                    // Start MrHeadActivity with the Intent
